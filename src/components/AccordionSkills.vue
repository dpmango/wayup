  ...
  v-expansion-panels.acc-exercises__panels(v-model="panel" multiple)
    v-expansion-panel.acc-exercises__panel
      v-expansion-panel-header.acc-exercises__header.flex-column.align-start
        ...
        .text-small.ml-7.mt-3 При оценке от 1 до 3 необходимо указать ошибки, которые допускает спортсмен
        ...
        .mistake__block
          ...
          .mistake__block-right
            .mistake__row.mb-4
              ...
              a(href='#').ml-5
                img.icon-16(
                  src="@/assets/images/svg/icon-cart.svg"
                )
            ...
            a(href="#").add-link
              svg.plus-icon(width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg')
                path(d='M12 7V17M17 12L7 12' stroke='#326BFF' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round')
              .add-link__text Добавить фактор
