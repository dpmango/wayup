    ...
    .widget-header
      ...
      .widget-header__bottom
        .statistic-season__head
          .statistic-td.text-left(style="width:10%") Соперник
          .statistic-td.text-left Дата
          .statistic-td В
          .statistic-td П
          .statistic-td Н
          .statistic-td ПГ
      ...
      vue-custom-scrollbar(
        ...
        .statistic-season__body
          .widget__item.mb-1(
            ...
            .statistic-td.text-left(style="width:10%") {{ item.opponent }}
            .statistic-td.text-left.text-blue {{ item.date }}
            .statistic-td {{ item.v }}
            .statistic-td {{ item.p }}
            .statistic-td {{ item.n }}
            .statistic-td {{ item.pg }}
            .statistic-td {{ item.ob }}
            .statistic-td {{ item.br }}
            .statistic-td {{ item.brPercent }}
            .statistic-td {{ item.io }}
            .statistic-td {{ item.iv }}
